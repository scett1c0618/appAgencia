...
namespace apptienda.ML
{
    ...
    {
        public const string RetrainFilePath = @"C:\Users\fduar\Downloads\RatingFictisio.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: @"productId", inputColumnName: @"productId", addKeyValueAnnotationsAsText: false)
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options() { LabelColumnName = @"rating", MatrixColumnIndexColumnName = @"userId", MatrixRowIndexColumnName = @"productId", ApproximationRank = 15, LearningRate = 0.11160239054773088, NumberOfIterations = 118, Quiet = true }))
